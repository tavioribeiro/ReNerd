package com.podcast.renerd.features.episodes.components.last_episodes_dialog.adapters
...
import com.podcast.renerd.core.extentions.getSizes
...
class LastEpisodesEpisodesAdapter(
    private val resources: Resources,
    private val episodesList: List<EpisodeViewModel>,
    private val onClick: (EpisodeViewModel) -> Unit
) : RecyclerView.Adapter<LastEpisodesEpisodesAdapter.FilterItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilterItemViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.r_last_episodes_dialog_item_adapter, parent, false)
