...
import com.podcast.renerd.core.extentions.fadeInAnimation
...
//        log("\n\nFloating Player startEpisode currentEpisode: ${currentEpisode.title} | ${currentEpisode.elapsedTime}")
    ...
    companion object {
        const val PLAYER_STATUS_UPDATE = "com.podcast.renerd.components.floating_player.PLAYER_STATUS_UPDATE"
